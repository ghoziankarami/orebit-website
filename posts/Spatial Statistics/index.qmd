...
With validated data from [Part 1](post-01-data-validation.qmd), we now explore **where** the data is located and **what** it tells us statistically. This post covers:
...
With spatial and statistical understanding complete, you're ready to connect these patterns to geology in [Part 3: Geological Controls & Domain Definition](post-03-geological-domains.qmd).
:::
...
*Previous: [← Part 1 - Data Validation](post-01-data-validation.qmd)*
